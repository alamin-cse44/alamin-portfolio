...
export function ClientWork() {
  return (
    <section id="client-work" className="relative z-10 py-24 md:py-32 border-t border-border-soft">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {clientWork.map((c) => (
            ...
            >
              ...
              <span className="text-sm text-faint font-mono mt-5">visit site ↗</span>
            </a>
          ))}
        </div>
      </div>
